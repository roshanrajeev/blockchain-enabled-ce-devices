...
start cmd /k "cd D:\Practice\blockchain-enabled-ce-devices\fog-server && set HTTP_PORT_CHAIN=3003 && set PEERS=ws://localhost:4001,ws://localhost:4002 && yarn run dev"